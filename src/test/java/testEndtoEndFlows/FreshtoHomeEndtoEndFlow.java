...
public class FreshtoHomeEndtoEndFlow extends BaseClass {
	...
	public Map<Integer, ArrayList<String>> FreshtoHomeSuccessTestCode() throws Exception {
		...
		driver.findElement(By.cssSelector("form[id='search_mini_form']>div>input"))
				.sendKeys("Yummy Chicken Cutlets - Pack of 3 (130g to 160g)");
		...
		wait.until(ExpectedConditions
				.elementToBeClickable(By.cssSelector("a[title='Yummy Chicken Cutlets - Pack of 3 (130g to 160g)']")));

		driver.findElement(By.cssSelector("a[title='Yummy Chicken Cutlets - Pack of 3 (130g to 160g)']")).click();
		...
		for (int i = 0; i < payMethodList.size(); i++) {
			...
			if (payMethodName.contains("Pay Later")) {
				...
				String actualtext = driver.findElement(By.cssSelector("div[data-paylater=\"getsimpl\"]>div:nth-child(2)"))
						.getText();
