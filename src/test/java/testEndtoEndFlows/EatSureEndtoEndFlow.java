...
//		Thread.sleep(5000);
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[contains(@class,'ixHvOP')]")));

		driver.findElement(By.xpath("//button[contains(@class,'ixHvOP')]")).click();
