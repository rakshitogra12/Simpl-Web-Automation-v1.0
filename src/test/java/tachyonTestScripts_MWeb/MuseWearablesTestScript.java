...
public class MuseWearablesTestScript extends BaseClass {
	...
	public void MuseWearablesMethodUsingPDPPageButtonApprovedScenario() throws Exception {
		...
		driver.findElement(By.xpath("//a[contains(@class,'t4s-push-menu-btn')]")).click();

		driver.findElement(By.xpath("(//a[contains(text(),'Muse Watch')])[3]")).click();
		...
		new WebDriverWait(driver, Duration.ofSeconds(20)).until(
				ExpectedConditions.frameToBeAvailableAndSwitchToIt(By.cssSelector("iframe[id='ba-widget-iframe']")));

		new WebDriverWait(driver, Duration.ofSeconds(20))
				.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[id='close_ba_widget']")));

		driver.findElement(By.cssSelector("a[id='close_ba_widget']")).click();
