...
public class CrownchiTestScript extends BaseClass {

	ReadConfig readconfig = new ReadConfig();

	@Test(priority = 1)
	public void CrownchiMethodUsingPDPPageButtonApprovedScenario() throws Exception {

		String merchantName = "Crownchi";

		driver.get(readconfig.getcrownchiURL());

		driver.manage().window().maximize();

		WebElement element1 = driver
				.findElement(By.xpath("(//a[contains(@href,'lucas-black-round-edition-sunglasses')])[2]"));
		...
		new WebDriverWait(driver, Duration.ofSeconds(20)).until(ExpectedConditions
				.presenceOfElementLocated(By.xpath("//div[contains(text(),'Lucas Black Round Edition Sunglasses')]")));

		String productTitle = driver
				.findElement(By.xpath("//div[contains(text(),'Lucas Black Round Edition Sunglasses')]")).getText();
	...
	@Test(priority = 2)
	public void CrownchiMethodUsingAjaxCartButtonApprovedScenario() throws Exception {
	...
	@Test(priority = 3)
	public void CrownchiMethodUsingPDPPageButtonUnapprovedScenario() throws Exception {
	...
	@Test(priority = 4)
	public void CrownchiMethodWrongOTPScenario() throws Exception {
