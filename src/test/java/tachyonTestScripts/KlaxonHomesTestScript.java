...
public class KlaxonHomesTestScript extends BaseClass {

	ReadConfig readconfig = new ReadConfig();

	@Test(priority = 1)
	public void KlaxonHomesMethodUsingPDPPageButtonApprovedScenario() throws Exception {

		driver.get(readconfig.getklaxonhomesURL());

		driver.manage().window().maximize();

		WebElement element1 = driver.findElement(By.xpath("(//a[contains(@href,'/collections/living-room')])[2]"));
		...
		new WebDriverWait(driver, Duration.ofSeconds(20)).until(ExpectedConditions.presenceOfElementLocated(By.xpath(
				"//div[contains(text(),'Klaxon Joe Wood & Metal Study Table, Laptop, Computer Table Desk - Walnut and Black')]")));
	...
	@Test(priority = 2)
	public void KlaxonHomesMethodUsingAjaxCartButtonApprovedScenario() throws Exception {
	...
	@Test(priority = 3)
	public void KlaxonHomesMethodUsingPDPPageButtonUnapprovedScenario() throws Exception {
	...
	@Test(priority = 4)
	public void KlaxonHomesMethodWrongOTPScenario() throws Exception {
