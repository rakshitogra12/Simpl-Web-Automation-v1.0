...
public class RuseTestScript extends BaseClass {
	...
	@Test(priority = 1)
	public void RuseMethodUsingAjaxCartButtonApprovedScenario() throws Exception {
		...
		driver.findElement(By.xpath("(//a[contains(@href,'/ruse-paw-and-snout-butter-vanilla')])[1]")).click();
		...
		String productTitle = driver
				.findElement(By.xpath("//div[contains(text(),'Ruse Paw and Snout Butter | Vanilla')]")).getText();
	...
	@Test(priority = 2)
	public void RuseMethodUsingAjaxCartPageButtonUnapprovedScenario() throws Exception {
	...
	@Test(priority = 3)
	public void RuseMethodWrongOTPScenario() throws Exception {
