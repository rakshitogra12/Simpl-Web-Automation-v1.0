...
public class BigBasketEndtoEndFlow extends BaseClass {
	...
	public Map<Integer, ArrayList<String>> BigBasketSuccessTestCode() throws Exception {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath(BigbasketFlowElements.gotItBtn)));

		driver.findElement(By.xpath(BigbasketFlowElements.gotItBtn)).click();
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath(BigbasketFlowElements.ContinuetoPaymentsbtn)));

		WebElement element3 = driver.findElement(By.xpath(BigbasketFlowElements.ContinuetoPaymentsbtn));
...
////		WebElement element3 = driver.findElement(By.xpath(BigbasketFlowElements.continuebtn));
//
//		Actions builder = new Actions(driver);
//
//		Action mouseOverHome = builder.moveToElement(element3).click().build();
...
//		mouseOverHome.perform();
	...
	public void bigBasketInsufficentCreditTestCode() throws InterruptedException {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(BigbasketFlowElements.Checkoutbtn)));

		driver.findElement(By.cssSelector(BigbasketFlowElements.Checkoutbtn)).click();
